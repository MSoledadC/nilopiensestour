...
<body>
  ...
  <div class="site-wrap">
          ...
          <div class="col-6 col-xl-2 text-right">
            <div class="d-none d-xl-inline-block">
              <ul class="site-menu js-clone-nav ml-auto list-unstyled d-flex text-right mb-0"          data-class="social">
                <li><a href="" class="pl-3 pr-3 text-white"><span class="icon-facebook"></span ></a></li>
                <li><a href="https://www.instagram.com/nilopiensestour?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="pl-3 pr-3 text-white"
                ><span class="icon-instagram"></span></a></li>  
                <li> <a href="https://www.linkedin.com/in/ni-lo-pienses-tours-4986a52a3/" target="_blank"
                    class="pl-3 pr-3 text-white"><span class="icon-linkedin"></span></a></li>
                <li> <a href="login.html" target="_blank" class="pl-3 pr-3 text-white"><span class="icon-user"></span
                ></a> </li>
              </ul>
            </div>
    ...
    <!-- header-end -->
    <div class="site-blocks-cover inner-page-cover" style="background-image: url(images/portadas/2.png);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
            ...
            <div class="row">
                ...
                <div class="image">
                  <div id="carouselExample<?php echo $itinerario['id']; ?>" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      ...
                      <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($itinerario['imagen']); ?>" alt="First slide">
                      </div>
              ...
              <div class="col-lg-8 align-self-center">
                <div class="content">
                  ...
                  <h4><?php echo $itinerario['nombre_itinerario']; ?></h4>
                  <div class="row">
                    <div class="col-4">
                      <i class="fa fa-clock"></i>
                      <span class="list"><?php echo $itinerario['noches']; ?> Noches</span>
                    </div>
                    <div class="col-8">
                      <i class="fa fa-map"></i>
                      <span class="list"><?php echo $itinerario['lugares_itinerario']; ?></span>
                    </div>
                  </div>
                  <p>Salida <?php echo $itinerario['fecha_salida']; ?><br>
                  <?php echo $itinerario['descripcion']; ?>
                    Incluye Aéreo + traslados + Asistencia + Excursiones + Desayunos<br>
                  </p>
                  <div>
                    <a href="submit-property.html" class="button">Editar</a>
                    <a href="#" class="button delete_user_car">Eliminar</a>
