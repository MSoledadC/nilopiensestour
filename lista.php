        ...
        <div class="col-xl-4 col-md-4">
          <div class="single_offers">
            <div class="box-image2">
              <div>
                <a class="box-image2__bg" href="#" style="background-image: url('data:image/jpg;base64,<?php echo base64_encode($reg['imagen']); ?>')">
                  <img src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen']); ?>" alt="">
                </a>
                <div class="box-image2__info">
                  <p class="box-image2__country"><?php echo $reg['nombre_itinerario']; ?></p>
                  <p class="box-image2__tour"><?php echo $reg['lugares_itinerario']; ?></p>
                </div>
                <div class="box-image2__info_bot">
                  <span class="box-image2__date">Fecha<?php echo $reg['fecha_salida']; ?></span>
...
<div class="amazing-deals">
  <div class="container">
    ...
    <div class="row">
      <?php while ($reg = mysqli_fetch_array($datos_itinerarios)) { ?>
                  ...
                  <div id="carouselExample<?php echo $reg['id']; ?>" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen']); ?>" alt="Imagen 1">
                      </div>
                      <?php if (!empty($reg['imagen2'])): ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen2']); ?>" alt="Imagen 2">
                      </div>
                      <?php endif; ?>
                      <?php if (!empty($reg['imagen3'])): ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen3']); ?>" alt="Imagen 3">
                      </div>
                      <?php endif; ?>
                      <?php if (!empty($reg['imagen4'])): ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen4']); ?>" alt="Imagen 4">
                      </div>
                      <?php endif; ?>
                      <?php if (!empty($reg['imagen5'])): ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen5']); ?>" alt="Imagen 5">
                      </div>
                      <?php endif; ?>
                    </div>
