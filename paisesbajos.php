...
<body>
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <div><a href="index.php">Inicio</a> <span class="mx-2 text-white">&bullet;</span> <span
                class="text-white">Paises Bajos</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    $consulta = "SELECT * FROM itinerarios WHERE pais = 'paisesbajos'";
                ...
                <div class="image">
                  <div id="carouselExample<?php echo $reg['id']; ?>" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen3']); ?>" alt="Second slide">
                      </div>
                      <?php } ?>
                      <?php if (!empty($reg['imagen4'])) { ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen4']); ?>" alt="Second slide">
                      </div>
                      <?php } ?>
                      <?php if (!empty($reg['imagen5'])) { ?>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen5']); ?>" alt="Second slide">
                      </div>
                      <?php } ?>
                    </div>
