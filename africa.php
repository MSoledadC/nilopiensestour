...
<body>
  ...
  <div class="site-wrap">
                ...
                <div class="col-6 col-xl-2 text-right">
                    <div class="d-none d-xl-inline-block">
                        <ul class="site-menu js-clone-nav ml-auto list-unstyled d-flex text-right mb-0"
                            ...
                            <li><a href="https://www.instagram.com/nilopiensestour?tm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="pl-3 pr-3 text-white"><span class="icon-instagram"></span></a>
                            </li>
    ...
    <div class="site-blocks-cover inner-page-cover paginas_destinos" style="background-image: url(images/portadas/23.webp);"
        ...
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <div><a href="index.php">Inicio</a> <span class="mx-2 text-white">&bullet;</span> <span
                class="text-white">África</span></div>
  ...
  $consulta = "SELECT * FROM itinerarios WHERE continente = 'africa'";
      ...
      <?php while ($reg = mysqli_fetch_array($datos)) { ?>
        <div class="col-lg-8 offset-lg-2">
          <div class="section-heading text-center">
            <h2 class="font-weight-light text-black text-center"><?php echo ucwords(htmlspecialchars($reg['nombre_itinerario'])); ?></h2>
          </div>
        </div>
        <div class="col-md-12 col-sm-12">
          <div class="itinerario">
            <div class="row">
              <div class="col-lg-4">
                <div class="image">
                  <div id="carouselExample<?php echo $reg['id']; ?>" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen']); ?>" alt="First slide">
                      </div>
                      <?php if (!empty($reg['imagen2'])) { ?>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen2']); ?>" alt="Second slide">
                        </div>
                      <?php } ?>
                      <?php if (!empty($reg['imagen3'])) { ?>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen3']); ?>" alt="3 slide">
                        </div>
                      <?php } ?>
                      <?php if (!empty($reg['imagen4'])) { ?>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen4']); ?>" alt="4 slide">
                        </div>
                      <?php } ?>
                      <?php if (!empty($reg['imagen5'])) { ?>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="data:image/jpg;base64,<?php echo base64_encode($reg['imagen5']); ?>" alt="5 slide">
                        </div>
                      <?php } ?>
                    </div>
                    <a class="carousel-control-prev" href="#carouselExample<?php echo $reg['id']; ?>" role="button" data-slide="prev">
                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#carouselExample<?php echo $reg['id']; ?>" role="button" data-slide="next">
              ...
              <div class="col-lg-8 align-self-center">
                <div class="content">
                  ...
                  <div class="row">
                    <div class="col-8">
                      <h4><?php echo ucwords(htmlspecialchars($reg['nombre_itinerario'])); ?></h4>
                      <i class="fa fa-map"></i>
                      <span class="list"><?php echo htmlspecialchars($reg['lugares_itinerario']); ?></span>
                    </div>
                  </div>
                  <p><?php echo nl2br(htmlspecialchars($reg['datos_excursion'])); ?></p>
                  <hr>
                  <!-- Descripción -->
